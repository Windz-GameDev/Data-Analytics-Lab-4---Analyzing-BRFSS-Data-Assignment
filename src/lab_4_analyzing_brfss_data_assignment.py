"""
  Title: Data Analytics Lab 4 - Analyzing BRFSS Data Assignment
  Author: Aaron Goldstein
  Date 2/25/2023
  Github Repo: https://github.com/Windz-GameDev/Data-Analytics-Lab-4---Analyzing-BRFSS-Data-Assignment

  In this program, we analyze BRFSS weight vs. height data from a CSV file. The data has five attributes:
